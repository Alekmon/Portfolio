            ...
            <div class="flex flex-col md:flex-row">
                ...
                <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                    <div class="w-full">
                        ...
                        <form action="{{ route('reservation.storeOne') }}" method="POST">
                            @csrf
                            ...
                            <div class="sm:col-span-6">
                                <label for="tel_number" class="block text-sm font-medium text-gray-700"> Телефон
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-1">
                                    <input type="datetime-local" id="res_date" name="res_date" value="" min="{{ $minDate }}" max="{{ $maxDate }}" value="{{ $reservation ? $reservation->res_date : '' }}"
                                        class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                <span class="text-xs">Please choose the time between 18:00-23:00.</span>
                                @error('res_date')
                                    <div class="text-sm text-red-400">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="sm:col-span-6">
                                <label for="guest_number" class="block text-sm font-medium text-gray-700"> Колличество Гостей
                                </label>
                                <div class="mt-1">
